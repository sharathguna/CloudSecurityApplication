...
/////////////////
	...
	String ip=(String)JOptionPane.showInputDialog(this,"Enter The Client ID:");

if(Fn==null ||Fn.equals("")||ip.equals(""))
	{
...
private void add_rss(String f,String allowedip)
{
        dbcon dbcon1 = new dbcon();
       dbcon1.add_res(f,allowedip);
        String s = dbcon1.listfile();
        Vector vector = new Vector(2);
        String s1;
        for(StringTokenizer stringtokenizer = new StringTokenizer(s, ";"); stringtokenizer.hasMoreTokens(); vector.addElement(s1))
